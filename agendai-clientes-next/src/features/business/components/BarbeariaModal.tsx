                ...
                <div className="space-y-3">
                  {services.length > 0 ? (
                    services.map((service) => (
                      ...
                      >
                        <div className="w-16 h-16 rounded-lg bg-[#3a3a3a] flex items-center justify-center shrink-0">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <button
                          ...
                          className="bg-indigo-500 text-white text-xs font-semibold px-4 py-2 rounded-lg hover:bg-indigo-600 transition-colors shrink-0"
                        >
                          Agendar
                        </button>
                      </div>
