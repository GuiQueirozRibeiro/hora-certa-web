    ...
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-300 leading-relaxed">
          A Agendai leva a privacidade e a proteção de dados muito a sério. Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos suas informações pessoais em conformidade com a Lei Geral de Proteção de Dados (LGPD - Lei 13.709/2018) e demais legislações aplicáveis.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-300"><strong>2.4. Controlador:</strong> Agendai, responsável pelas decisões sobre o tratamento de dados pessoais.</p>
        <p className="text-gray-300"><strong>2.5. Operador:</strong> Terceiros que processam dados em nome do Agendai.</p>
      </section>
      ...
      <div className="border-t border-zinc-700 pt-6 mt-8">
        <p className="text-sm text-gray-400 text-center">
          Ao utilizar a Plataforma Agendai, você declara ter lido, compreendido e concordado com esta Política de Privacidade e Proteção de Dados.
        </p>
