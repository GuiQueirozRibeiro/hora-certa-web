  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-zinc-700 pb-6">
        <h1 className="text-3xl font-bold mb-2">TERMOS DE SERVIÇO - Agendai</h1>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-300 leading-relaxed">
          Bem-vindo ao Agendai. Ao acessar e utilizar nossa plataforma (aplicativo móvel e site), você concorda em cumprir e estar vinculado aos seguintes Termos de Serviço. Se você não concorda com estes termos, não utilize nossos serviços.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-gray-300"><strong>2.1.</strong> "Plataforma" refere-se ao aplicativo móvel Agendai e ao website associado.</p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-300"><strong>3.1.</strong> O Agendai é uma plataforma digital que conecta usuários a estabelecimentos prestadores de serviços, permitindo:</p>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-300 ml-4">
              ...
              <li>O Agendai pode cobrar uma taxa de processamento sobre as transações</li>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-300"><strong>8.3.</strong> Cancelamentos pelo estabelecimento podem gerar compensação ao usuário a critério do Agendai.</p>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-gray-300"><strong>10.1.</strong> Todos os direitos sobre a Plataforma Agendai, incluindo mas não se limitando a marca, logotipo, código-fonte, design de interface e conteúdo, são de propriedade exclusiva do Agendai e estão protegidos pelas leis de direitos autorais e propriedade intelectual.</p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-gray-300"><strong>11.1.</strong> O Agendai não se responsabiliza por:</p>
          <ul className="list-disc list-inside space-y-1 text-gray-300 ml-4">
      ...
      <div className="border-t border-zinc-700 pt-6 mt-8">
        <p className="text-sm text-gray-400 text-center">
          Ao utilizar a Plataforma Agendai, você declara ter lido, compreendido e concordado com estes Termos de Serviço.
        </p>
