    ...
    <section className="w-full py-10 md:py-12 bg-zinc-900">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 md:p-4 text-left hover:bg-zinc-800 transition-colors duration-200"
                >
        ...
        <div className="mt-6 md:mt-8 text-center bg-zinc-800 rounded-xl p-4 md:p-6 border border-zinc-700">
          ...
          <button className="px-5 py-2 bg-indigo-600 text-white text-xs font-semibold rounded-lg hover:bg-indigo-500 transition-all duration-200 active:scale-95">
            Entrar em Contato
          </button>
        </div>
      </div>
